...
var ThreadVis = (function(ThreadVis) {
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Threader.addMessage = function(message) {
     ...
     * Find a message
     * 
     * @return messageId The message id to search
     * @return The found message, null if message does not exist
     **************************************************************************/
    ThreadVis.Threader.findContainer = function(messageId) {
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Threader.putMessageInContainer = function(message) {
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Threader.reset = function() {
        this.idTable = {};
    }
