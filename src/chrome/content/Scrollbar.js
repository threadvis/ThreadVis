...
var ThreadVis = (function(ThreadVis) {
    ...
    ThreadVis.Scrollbar = function(visualisation, stack, box) {
         ...
         */
        this.boxHorizontal = document
                .getElementById("ThreadVisScrollbarHorizontalBox");
        this.horizontal = document
     ...
     * 
     * @return object.x is the x-position of the horizontal scrollbar object.y
     *         is the y-position of the vertical scrollbar
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.calculatePosition = function() {
        var movedX = Math.abs(parseFloat(this.stack.style.marginLeft));
        var movedY = Math.abs(parseFloat(this.stack.style.marginTop));

        var x = (movedX / this.getStackWidth())
                * this.getScrollBarHorizontalWidth();
        var y = (movedY / this.getStackHeight())
     ...
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.calculateSize = function() {
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.draw = function() {
        this.reset();
     ...
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.getScrollBarHorizontalWidth = function() {
     ...
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.getScrollBarVerticalHeight = function() {
     ...
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.getStackHeight = function() {
     ...
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.getStackWidth = function() {
     ...
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.getTotalHeight = function() {
     ...
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.getTotalWidth = function() {
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.init = function(box) {
        this.box = box;
    }
     ...
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.isShown = function() {
     ...
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.isShownVertical = function() {
     ...
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.isShownHorizontal = function() {
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.onMouseMoveHorizontal = function(event) {
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.onMouseDownHorizontal = function(event) {
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.onMouseUpHorizontal = function(event) {
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.onMouseMoveVertical = function(event) {
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.onMouseDownVertical = function(event) {
        if (event.button != 0) {
            return;
        }
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.onMouseUpVertical = function(event) {
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.panDown = function() {
        this.panVertical(1);
    }
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.panHorizontal = function(dx) {
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.panLeft = function() {
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.panRight = function() {
        this.panHorizontal(1);
    }
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.panUp = function() {
        this.panVertical(-1);
    }
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.panVertical = function(dy) {
     ...
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.reset = function() {
    ...
    /***************************************************************************
     * Reset size of scrollbar to 0 on window resize. Otherwise, window can't be
     * resized to a size smaller than the scrollbars.
     * 
     * @return void
     **************************************************************************/
    ThreadVis.Scrollbar.prototype.resize = function() {
        this.reset();
        this.draw();
    }
